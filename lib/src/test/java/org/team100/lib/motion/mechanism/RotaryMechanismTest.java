...
public class RotaryMechanismTest {
    ...
    void testLimits() {
        ...
        double gearRatio = 1;
        RotaryMechanism mech = new RotaryMechanism(logger, motor, encoder, gearRatio, 1, 2);
    ...
    void testUnlimited() {
        ...
        RotaryMechanism mech = new RotaryMechanism(
                logger, motor, encoder, gearRatio, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
