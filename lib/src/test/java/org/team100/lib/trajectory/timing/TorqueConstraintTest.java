...
public class TorqueConstraintTest {
    ...
    void testRadial() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                Pose2dWithDirection.make(1, 0, 0, 0), 0, 0, 0);
    ...
    void testTangential() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                Pose2dWithDirection.make(1, 0, 0, Math.PI / 2), 0, 0, 0);
    ...
    void testInclined() {
        ...
        // moving +x+y at (1,0,0)
        Pose2dWithMotion state = new Pose2dWithMotion(
                Pose2dWithDirection.make(1, 0, 0, Math.PI / 4), 0, 0, 0);
    ...
    void testFar() {
        ...
        // moving +y at (2,0,0)
        Pose2dWithMotion state = new Pose2dWithMotion(
                Pose2dWithDirection.make(2, 0, 0, Math.PI / 2), 0, 0, 0);
        // more r => lower limit
