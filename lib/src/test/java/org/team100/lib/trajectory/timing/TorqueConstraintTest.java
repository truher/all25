...
public class TorqueConstraintTest {
    ...
    void testMotionless() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                new Pose2d(1, 0, Rotation2d.kZero), new MotionDirection(0, 0, 0), 0, 0);
    ...
    void testRadial() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                new Pose2d(1, 0, Rotation2d.kZero), new MotionDirection(1, 0, 0), 0, 0);
    ...
    void testTangential() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                new Pose2d(1, 0, Rotation2d.kZero), new MotionDirection(0, 1, 0), 0, 0);
    ...
    void testInclined() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                new Pose2d(1, 0, Rotation2d.kZero), new MotionDirection(1, 1, 0), 0, 0);
    ...
    void testFar() {
        ...
        Pose2dWithMotion state = new Pose2dWithMotion(
                new Pose2d(2, 0, Rotation2d.kZero), new MotionDirection(0, 1, 0), 0, 0);
        // more r => lower limit
