...
class TargetUtilTest {
    ...
    void testTargetMotion() {
        ...
        SwerveModel state = new SwerveModel(new Pose2d(), new GlobalSe2Velocity(1, 0, 0));
    ...
    void testTargetMotionFaster() {
        ...
        SwerveModel state = new SwerveModel(new Pose2d(), new GlobalSe2Velocity(2, 0, 0));
        // target is 1m to the left
        Translation2d target = new Translation2d(0, 1);
        // so it appears to move clockwise
    ...
    void testTargetMotionElsewhere() {
        ...
        SwerveModel state = new SwerveModel(new Pose2d(1, 1, new Rotation2d()), new GlobalSe2Velocity(1, 0, 0));
        // target is 1m to the left
    ...
    void testTargetMotionY() {
        ...
        SwerveModel state = new SwerveModel(new Pose2d(), new GlobalSe2Velocity(0, 1, 0));
        // target is dead ahead
