...
public class PIDControllerAccelWPITest {
    private static final double kDelta = 0.001;
    private static final LoggerFactory logger = new TestLoggerFactory(new TestPrimitiveLogger());

    @Test
    public void testCalculate() {
        PIDControllerAccelWPI c = new PIDControllerAccelWPI(logger, 1, 0, 0, false);
        ...
        assertEquals(1e-4, u.x(), kDelta);
        assertEquals(0.02, u.v(), kDelta);
        assertEquals(1, u.a(), kDelta);
