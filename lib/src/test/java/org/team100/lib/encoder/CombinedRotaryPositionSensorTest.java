...
class CombinedRotaryPositionSensorTest implements Timeless {
    ...
    void testZeroing() {
        ...
        sensor.angle = 1;
        assertEquals(1, sensor.getPositionRad(), DELTA);
        ...
        assertEquals(0, proxy.getPositionRad(), DELTA);
        ...
        assertEquals(0.0, combined.getPositionRad(), DELTA);
