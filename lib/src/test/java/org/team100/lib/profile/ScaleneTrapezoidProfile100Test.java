 ...
 * of max velocity.
 */
class ScaleneTrapezoidProfile100Test {
    ...
    /**
     * Verify different accel and decel.
     * see
     * https://docs.google.com/spreadsheets/d/1UWvKZJEHhSgE4jDpu1_B3dda_JZ244JZQIJ3bJsoTX4
     */
    @Test
    void testScalene() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(20, 100, 50, 0.01);
        Control100 control = new Control100();
        final Model100 goal = new Model100(1, 0);
        final double dt = 0.02;
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.02, control.x(), kDelta);
        assertEquals(2, control.v(), kDelta);
        assertEquals(100, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.08, control.x(), kDelta);
        assertEquals(4, control.v(), kDelta);
        assertEquals(100, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.18, control.x(), kDelta);
        assertEquals(6, control.v(), kDelta);
        assertEquals(100, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.32, control.x(), kDelta);
        assertEquals(8, control.v(), kDelta);
        assertEquals(100, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.5, control.x(), kDelta);
        assertEquals(10, control.v(), kDelta);
        assertEquals(100, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.68, control.x(), kDelta);
        assertEquals(9, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.82, control.x(), kDelta);
        assertEquals(8, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.92, control.x(), kDelta);
        assertEquals(7, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(0.98, control.x(), kDelta);
        assertEquals(6, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(5, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(4, control.v(), kDelta);
        ...
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(3, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(2, control.v(), kDelta);
        ...
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(1, control.v(), kDelta);
        assertEquals(-50, control.a(), kDelta);
        control = p2.calculate(dt, control.model(), goal);
        assertEquals(1, control.x(), kDelta);
        assertEquals(0, control.v(), kDelta);
        assertEquals(0, control.a(), kDelta);
    }

    /** I think we're writing followers incorrectly, here's how to do it. */
    @Test
    void discreteTime1() {
        final Profile100 profile = new ScaleneTrapezoidProfile100(2, 1, 1, 0.01);
    ...
    void testTooHighEntryVelocity() {
        ScaleneTrapezoidProfile100 p = new ScaleneTrapezoidProfile100(1, 1, 1, 0.01);
    ...
    @Test
    void testETAAtGoal() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(1, 1, 1, 0.01);
    ...
    void testETASolve() {
        ...
        double s = ScaleneTrapezoidProfile100.solveForSlowerETA(1, 1, 0.01, 0.02, initial, goal, 2, kDelta);
        assertEquals(1.0, s, kDelta);
        s = ScaleneTrapezoidProfile100.solveForSlowerETA(1, 1, 0.01, 0.02, initial, goal, 3, kDelta);
        assertEquals(0.439, s, kDelta);
        s = ScaleneTrapezoidProfile100.solveForSlowerETA(1, 1, 0.01, 0.02, initial, goal, 4, kDelta);
        assertEquals(0.242, s, kDelta);
        s = ScaleneTrapezoidProfile100.solveForSlowerETA(1, 1, 0.01, 0.02, initial, goal, 8, kDelta);
    ...
    void testBrokenSolve1() {
        ...
        double maxA = 10;
        double tol = 0.01;
        ScaleneTrapezoidProfile100 px = new ScaleneTrapezoidProfile100(maxV, maxA, maxA, tol);
        ...
        double s = ScaleneTrapezoidProfile100.solveForSlowerETA(
    ...
    void testETARestToRestScaled1() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(0.5, 1, 1, 0.01);
        Model100 initial = new Model100(0, 0);
        Model100 goal = new Model100(1, 0);
        ResultWithETA s = p2.calculateWithETA(0.02, initial, goal);
    ...
    void testETARestToRestScaled2() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(0.5, 0.5, 0.5, 0.01);
        Model100 initial = new Model100(0, 0);
        Model100 goal = new Model100(1, 0);
        ResultWithETA s = p2.calculateWithETA(0.02, initial, goal);
        assertEquals(0.0, s.state().x(), kDelta);
    ...
    void testETARestToRestScaled3() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(0.25, 0.25, 0.25, 0.01);
        Model100 initial = new Model100(0, 0);
        Model100 goal = new Model100(1, 0);
        ResultWithETA s = p2.calculateWithETA(0.02, initial, goal);
        assertEquals(0.0, s.state().x(), kDelta);
    ...
    @Test
    void testAccel1() {
        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(3, 2, 2, 0.01);
        Model100 initial = new Model100(0, 0);
        Model100 goal = new Model100(1, 0);
    ...
    @Test
    void testIntercepts() {
        ScaleneTrapezoidProfile100 p = new ScaleneTrapezoidProfile100(5, 0.5, 0.5, 0.01);
        Model100 s = new Model100(1, 1);
        assertEquals(0, p.c_plus(s), kDelta);
        assertEquals(2, p.c_minus(s), kDelta);

        // more accel
        p = new ScaleneTrapezoidProfile100(5, 1, 1, 0.01);
        s = new Model100(1, 1);
        // means less offset
    ...
    void testInterceptsFromRRT() {
        ScaleneTrapezoidProfile100 p = new ScaleneTrapezoidProfile100(5, 1, 1, 0.01);

        ScaleneTrapezoidProfile100 p2 = new ScaleneTrapezoidProfile100(5, 2, 2, 0.01);
    ...
    @Test
    void testTriangle() {
        ScaleneTrapezoidProfile100 profileX = new ScaleneTrapezoidProfile100(5, 2, 2, 0.1);
    ...
    void testInvertedTriangle() {
        ScaleneTrapezoidProfile100 profileX = new ScaleneTrapezoidProfile100(5, 2, 2, 0.01);
        Control100 sample = new Control100(0, 0);
        final Model100 end = new Model100(-1, 0);
    ...
    @Test
    void testCruise() {
        ScaleneTrapezoidProfile100 profileX = new ScaleneTrapezoidProfile100(1, 2, 2, 0.01);
        Control100 sample = new Control100(0, 0);
        final Model100 end = new Model100(1, 0);
    ...
    @Test
    void testWindupCase() {
        ScaleneTrapezoidProfile100 profileX = new ScaleneTrapezoidProfile100(5, 2, 2, 0.05);
        Control100 sample = new Control100(0, 0);
    ...
    void reachesGoal() {
        ...
        ScaleneTrapezoidProfile100 profile = new ScaleneTrapezoidProfile100(1.75, 0.75, 0.75, 0.01);
        for (int i = 0; i < 450; ++i) {
    ...
    void posContinuousUnderVelChange() {
        ...
        for (int i = 0; i < 1600; ++i) {
            if (i == 400) {
                ...
                profile = new ScaleneTrapezoidProfile100(0.75, 0.75, 0.75, 0.01);
            }
    ...
    void backwards() {
        ...
        ScaleneTrapezoidProfile100 profile = new ScaleneTrapezoidProfile100(0.75, 0.75, 0.75, 0.01);
        for (int i = 0; i < 400; ++i) {
            state = profile.calculate(k10ms, state.model(), goal);
        }
        assertEquals(goal.x(), state.x(), 0.05);
