...
public class Manipulator extends SubsystemBase {
    ...
    public Manipulator(LoggerFactory log) {
        m_leftMotor = new Kraken6Motor(log, 54, MotorPhase.FORWARD, 40, 40, new PIDConstants(),
                Feedforward100.makeShooterFalcon6());
        m_rightMotor = new Kraken6Motor(log, 55, MotorPhase.REVERSE, 40, 40, new PIDConstants(),
                Feedforward100.makeShooterFalcon6());
        m_algaeMotor = new Kraken6Motor(log, 56, MotorPhase.FORWARD, 120, 120, new PIDConstants(),
                Feedforward100.makeShooterFalcon6());
        ...
        LinearMechanism linearMechanism = new LinearMechanism(log, m_leftMotor, new Talon6Encoder(log, m_leftMotor), 16,
                .1, -100000000, 1000000);
        // LinearMechanism linearMechanism = new LinearMechanism(log, m_leftMotor, new
        // Talon6Encoder(log, m_leftMotor), 16, .1, -100000000, 1000000);
        // LinearMechanism linearMechanism = new LinearMechanism(log, m_leftMotor, new
        // Talon6Encoder(log, m_leftMotor), 16, .1, -100000000, 1000000);
