...
public class GoToProcessor extends SequentialCommandGroup {
    public GoToProcessor(FieldLogger.Log fieldLog, SwerveDriveSubsystem m_drive, SwerveController holonomicController,
            HolonomicProfile profile, AlgaeGrip algaeGrip) {
        addCommands(
