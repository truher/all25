...
public class DriveTo_ABNew extends Navigator {
    ...
    public void initialize() {
        ...
        switch (originSector) {
            ...
            case EF:
                ...
                waypointsM.add(new Pose2d(
                        FieldConstants.getOrbitLandingZone(destinationSector, FieldConstants.ReefDestination.CW),
            ...
            case GH:
                ...
                waypointsM.add(new Pose2d(
                        FieldConstants.getOrbitLandingZone(destinationSector, FieldConstants.ReefDestination.CCW),
                        Rotation2d.fromDegrees(-110)));
                waypointsM.add(new Pose2d(FieldConstants.getOrbitDestination(destinationSector, destinationPoint),
                        Rotation2d.fromDegrees(-70)));
