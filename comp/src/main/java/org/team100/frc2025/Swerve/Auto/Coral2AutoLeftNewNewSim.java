...
public class Coral2AutoLeftNewNewSim extends SequentialCommandGroup100 {

    public Coral2AutoLeftNewNewSim(
        ...
        PostDropAndReadyFunnel postDropAndReadyFunnelFromI = new PostDropAndReadyFunnel(wrist, elevator, 10,
                (goToStation1stTime::isDone));

        PostDropAndReadyFunnel postDropAndReadyFunnelFromK = new PostDropAndReadyFunnel(wrist, elevator, 10,
