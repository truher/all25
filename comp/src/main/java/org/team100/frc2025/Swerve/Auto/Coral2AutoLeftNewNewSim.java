...
public class Coral2AutoLeftNewNewSim extends SequentialCommandGroup100 {
    ...
    public Coral2AutoLeftNewNewSim(
        ...
        Embark embarkToL = new Embark(
                m_logger, drive, heedRadiusM, controller, profile, FieldSector.KL,
                ReefDestination.RIGHT, () -> ScoringPosition.L4, ReefPoint.L);
