...
public class ScoreL3 extends SequentialCommandGroup {
  ...
  public ScoreL3(Wrist2 wrist, Elevator elevator) {
    ...
    addCommands(
        ...
        new ParallelDeadlineGroup(new SetWrist(wrist, 0.9, true), new SetElevatorPerpetually(elevator, 23)),
        new ParallelDeadlineGroup(new SetElevator(elevator, 18, false), new SetWrist(wrist, 0.9, true))
