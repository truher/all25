...
/**
 * Kinematics for the two-jointed planar arm used in 2023. The coordinates used
 * here are not what we would do now.
 */
public class ArmKinematics23 {
     ...
     * @param l2 distal
     */
    public ArmKinematics23(double l1, double l2) {
        this.l1 = l1;
        this.l2 = l2;
    }
     ...
     * @return end position
     */
    public Translation2d forward(ArmAngles23 a) {
     ...
     */
    public Translation2d elbow(ArmAngles23 a) {
     ...
     */
    public ArmAngles23 inverse(Translation2d t) {
        ...
        if (Double.isNaN(th1) || Double.isNaN(th2))
            return null;
        return new ArmAngles23(th1, th2);
    }
     ...
     */
    public ArmAngles23 inverseVel(ArmAngles23 pos, Translation2d vel) {
        if (pos == null) {
            Util.warn("NULL ARM POSITION in ArmKinematics.inverseVel()");
            return new ArmAngles23(0, 0);
        }
        double dx = vel.getX();
        double dy = vel.getY();
        ...
        return new ArmAngles23(dth1, dth2);
    }
