...
public class FiveBarMech extends SubsystemBase {
    ...
    public FiveBarMech(LoggerFactory logger) {
        ...
        Falcon6Motor motorP1 = new Falcon6Motor(
                ...
                pid,
                ff);
        IncrementalBareEncoder encoderP1;
        encoderP1 = new Talon6Encoder(loggerP1, motorP1);
        ...
        Falcon6Motor motorP5 = new Falcon6Motor(
                ...
                pid,
                ff);
        IncrementalBareEncoder encoderP5;
        encoderP5 = new Talon6Encoder(loggerP5, motorP5);
