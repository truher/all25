...
public class Jacobian {
    ...
    public static Vector<N3> config(Config c) {
        return VecBuilder.fill(c.shoulderHeight(), c.shoulderAngle(), c.wristAngle());
    }

    public static Config config(Vector<N3> q) {
        return new Config(q.get(0), q.get(1), q.get(2));
    }
